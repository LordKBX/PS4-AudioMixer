...
set PKG_TITLE="OpenOrbis AudioMixer Sample"
set PKG_TITLE_CONDENSED=AUDIOMIXER
set PKG_VERSION="1.00"
set PKG_VERSION_FILENAME="0100"
set PKG_ASSETS="assets"
set PKG_TITLE_ID="KBXD00001"
set PKG_CONTENT_ID="IV0000-%PKG_TITLE_ID%_00-%PKG_TITLE_CONDENSED%000000"

Rem Libraries to link in
set libraries=-lc -lkernel -lc++ -lSceUserService -lSceAudioOut
...
move .\%PKG_CONTENT_ID%.pkg .\%PKG_TITLE_ID%-%PKG_TITLE_CONDENSED%_%PKG_VERSION_FILENAME%.pkg
del .\pkg.gp4
del .\eboot.bin
